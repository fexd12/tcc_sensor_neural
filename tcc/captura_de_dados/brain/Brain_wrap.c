...
extern "C" {
#endif
SWIGINTERN int Swig_var_Brain_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_class,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""Brain""' of type '""class""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""Brain""' of type '""class""'");
    } else {
      Brain = *((class *)(argp));
    }
  }
...
SWIGINTERN PyObject *Swig_var_Brain_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&Brain), SWIGTYPE_p_class,  0 );
  return pyobj;
}
...
# endif
  ...
  SWIG_Python_SetConstant(d, "MAX_PACKET_LENGTH",SWIG_From_int((int)(32)));
  SWIG_Python_SetConstant(d, "EEG_POWER_BANDS",SWIG_From_int((int)(8)));
  ...
  SWIG_addvarlink(globals, "Brain", Swig_var_Brain_get, Swig_var_Brain_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
